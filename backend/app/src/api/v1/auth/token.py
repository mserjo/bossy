...
@router.post(
    ...
    description="Перевіряє наданий токен доступу та повертає його розкодовані дані, якщо токен валідний. Доступно тільки суперкористувачам.", # i18n
...
async def verify_access_token_endpoint( # Перейменовано
    ...
    try:
        ...
        if not user_id_from_token:
            ...
            # i18n
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Некоректний формат токена: відсутній ідентифікатор користувача.")
