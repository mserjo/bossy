...
if __name__ == "__main__":
    ...
    print("--- Модель Шаблону Сповіщення (NotificationTemplate) ---")
    print(f"Назва таблиці: {NotificationTemplate.__tablename__}")
    ...
    print("TODO: Не забудьте визначити Enum 'NotificationChannelType' в core.dicts.py та оновити поле 'template_type'.")
