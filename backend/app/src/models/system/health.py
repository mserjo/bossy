...
if __name__ == "__main__":
    ...
    print("--- Модель Стану Здоров'я Сервісу (ServiceHealthStatus) ---")
    print(f"Назва таблиці: {ServiceHealthStatus.__tablename__}")
    ...
    print("TODO: Не забудьте визначити Enum 'HealthStatusType' в core.dicts.py та оновити поле 'status'.")
