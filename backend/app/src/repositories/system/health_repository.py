...
if __name__ == "__main__":
    ...
    print("--- Репозиторій Стану Здоров'я Сервісів (ServiceHealthStatusRepository) ---")
    ...
    print(f"Репозиторій працює з моделлю: {ServiceHealthStatus.__name__}.")
    print(f"  Очікує схему створення: backend.app.src.schemas.system.health.ServiceHealthStatusCreateSchema")
    print(f"  Очікує схему оновлення: backend.app.src.schemas.system.health.ServiceHealthStatusUpdateSchema")

    print("\nСпецифічні методи:")
    print("  - get_by_service_name(service_name: str)")
    print("  - get_unhealthy_services()")
    print("  - update_or_create_status(service_name: str, status: str, details: Optional[str])")

    print("\nПримітка: Повноцінне тестування репозиторіїв слід проводити з реальною тестовою базою даних.")
    print("TODO: Інтегрувати Enum 'HealthStatusType' для аргументу `status` та у фільтрах.")
    ...
    #     # print(f"Статус БД: {status_db}")
    #     #
    #     # unhealthy = await repo.get_unhealthy_services()
    #     # print(f"Нездорові сервіси: {unhealthy}")
    # import asyncio
