...
from typing import Optional, Dict, Any, List # Type видалено, залишаємо List, Optional, Dict, Any
from uuid import UUID, uuid4 # UUID та uuid4 використовуються для JTI
