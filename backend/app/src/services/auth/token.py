...
from backend.app.src.core.exceptions import InvalidTokenTypeError
...
class TokenService(BaseService):
    ...
    async def revoke_refresh_token(self, refresh_token_jti_str: str, user_id: Optional[int] = None) -> bool:
    ...
    async def revoke_all_refresh_tokens_for_user(self, user_id: int, exclude_jti: Optional[UUID] = None) -> int:
