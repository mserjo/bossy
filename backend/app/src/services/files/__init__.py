...
logger.info("File services sub-package initialized.")

# Import specific file-related service classes
# These imports assume the service files (e.g., file_record_service.py, file_upload_service.py)
# will be created in the same directory.

SERVICE_FILES = {
    "FileRecordService": ".file_record_service", # Or .file_service
    "FileUploadService": ".file_upload_service", # Or .upload_service
    "UserAvatarService": ".user_avatar_service", # Or .avatar_service
}
...
logger.info(f"File services sub-package exports: {__all__}")
