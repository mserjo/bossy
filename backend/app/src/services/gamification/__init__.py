...
logger.info("Gamification services sub-package initialized.")

# Import specific gamification-related service classes
# These imports assume the service files (level.py, badge.py, etc.)
# will be created in the same directory.

SERVICE_FILES = {
    "LevelService": ".level",
    "UserLevelService": ".user_level",
    "BadgeService": ".badge",
    "UserAchievementService": ".achievement",
    "UserRatingService": ".rating",
}
...
logger.info(f"Gamification services sub-package exports: {__all__}")
