...
│   │       │   ├── decorators.py    # Модуль для кастомних декораторів
...
│   │       │   │   ├── statuses.py     # SQLAlchemy модель для довідника "Статуси" (StatusModel)
│   │       │   │   ├── user_roles.py   # SQLAlchemy модель для довідника "Ролі користувачів" (UserRoleModel)
│   │       │   │   ├── group_types.py  # SQLAlchemy модель для довідника "Типи груп" (GroupTypeModel)
│   │       │   │   ├── task_types.py   # SQLAlchemy модель для довідника "Типи завдань" (TaskTypeModel)
│   │       │   │   ├── bonus_types.py  # SQLAlchemy модель для довідника "Типи бонусів" (BonusTypeModel)
│   │       │   │   └── integrations.py # SQLAlchemy модель для довідника "Зовнішні інтеграції" (IntegrationModel)
│   │       │   │
...
│   │       │   │   ├── settings.py  # Pydantic схеми для SystemSetting (SystemSettingCreate, SystemSettingUpdate, SystemSettingResponseSchema)
│   │       │   │   ├── monitoring.py# Pydantic схеми для SystemLog, PerformanceMetric
│   │       │   │   └── health.py    # Pydantic схеми для ServiceHealthStatus, HealthCheckResponseSchema, ComponentHealthSchema
│   │       │   │
...
│   │       │   │   ├── token.py     # Pydantic схеми для Token (TokenResponseSchema, RefreshTokenRequest)
