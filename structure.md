...
│   │   │   │   ├── dict_service.py  # Сервіс довідників
...
│   │   │   │   ├── dict_repository.py    # Репозиторій довідників
...
│   │   │   │   ├── offline/         # Утиліти
│   │   │   │   │   ├── sync_manager.dart         # Синхронізація даних
│   │   │   │   │   ├── offline_storage.dart      # Офлайн зберігання
│   │   │   │   │   └── connectivity_service.dart # Статус підключення
│   │   │   │   ├── utils/         # Утиліти
