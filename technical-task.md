...
backend: Python 3.13, FastAPI, PostgreSQL v17, Pydantic v2, SQLAlchemy v2, pytest, alembic
...
- Підтримка різних мов (одразу переклади для англійської, української) і UI, і контент, і помилки, і сповіщення
...
- Redis для черг/кешування (закласти можливість використання)
- Celery (закласти можливість використання)
...
- користувачам можуть надаватися рівні, бейджі, прогрес-бари за виконану кількість завдань/подій або накопиченими/заробленими бонусами (налаштовується в адміном групі)
...
- (довідник) тип завдання - завдання, підзавдання, складне завдання, подія, штраф;
